...
float PixL::Vec2::Distance( const Vec2& v1, const Vec2& v2 )
{
...
PixL::Vec2 PixL::Vec2::Normalized() const
{
    return { x / Magnitude(), y / Magnitude() };
}

float PixL::Vec2::SqrMagnitude() const
{
    return static_cast<float>( pow( x, 2 ) + pow( y, 2 ) );
}

float PixL::Vec2::Magnitude() const
{
...
//---------- Operation Overloads ----------
// Unary Arithmetic
PixL::Vec2 PixL::Vec2::operator+() const
{
    return *this;
}
PixL::Vec2 PixL::Vec2::operator-() const
...
// Binary Arithmetic
PixL::Vec2 PixL::Vec2::operator+( const Vec2& rhs ) const
{
...
PixL::Vec2 PixL::Vec2::operator*( const float& rhs ) const
{
    return { x * rhs, y * rhs };
}
PixL::Vec2 PixL::Vec2::operator/( const float& rhs ) const
...
// Comparison
bool PixL::Vec2::operator==( const Vec2& rhs ) const
{
    return ( x == rhs.x && y == rhs.y );
}
bool PixL::Vec2::operator!=( const Vec2& rhs ) const
